        ...
        <section className="mt-8">
          <div className="flex items-start p-4 border rounded-md">
            <div className="relative w-32 h-32 border rounded-md">
              ...
              <Button variant="ghost" className="absolute top-0 right-0 p-1">
                <FilePenIcon className="w-5 h-5 text-gray-500" />
              </Button>
            </div>
            <div className="ml-8 space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-2">
                  ...
                  <Input placeholder="1234 Placeholder Hill SE" />
                  <Input placeholder="Calgary" />
                  <Input placeholder="Alerta" />
                  <Input placeholder="T3R1A2" />
                </div>
              </div>
            </div>
          </div>
