...
export default function Nav() {
    ...
    return (
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <div>
            <Link href="../Patient/View-Patient-Page" className="flex items-center p-2 hover:bg-gray-700 rounded" prefetch={false}>
          ...
          <div>
            <Link href="../Staff-Management/View-Staff" className="flex items-center p-2 hover:bg-gray-700 rounded" prefetch={false}>
              <UserIcon className="w-5 h-5 mr-2" />
              Staff Management
              <ChevronDownIcon className="w-4 h-4 ml-auto" />
            </Link>
